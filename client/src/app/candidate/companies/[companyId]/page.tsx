        ...
        <div>
            ...
            <div className=" min-h-[90vh] w-full pb-20">
                ...
                <div className="h-full ">
                    ...
                    <div className="md:mx-20 mt-10 h-full ">
                        ...
                        <div className="flex md:flex-row flex-col justify-between gap-20 ">
                            ...
                            <div className="min-w-1/3 h-full flex justify-center flex-col items-center gap-20">
                                <div className="w-4/5 flex items-center justify-between bg-[#0b0b0bf6] rounded-lg py-5 px-8">
                                    <img src="/group.png" className=" " />
                                    <div className="bg-[#2a2727] text-[#2a2727] h-25">
                                        .
                                    </div>
                                    <div className="flex flex-col items-center gap-2">
                                        <h1 className='text-xl font-semibold'>Opennigs</h1>
                                        <h1 className='text-5xl syncAi font-bold'>{company?.jobPosts.length}</h1>
                                ...
                                <div className="rounded-lg flex-col gap-10 flex w-4/5  ">
                                    <h1 className='text-2xl font-medium text-center mx-auto ' >Company Benifits</h1>
                                    <div className="flex flex-wrap items-center gap-6 justify-evenly ">
                                        {
                                            company?.socialLinks.map((link, index) => (
                                                <div key={index} onClick={() => router.push(link.url)} className="px-4 py-1 rounded flex items-center gap-2 bg-[#041e5e80]">
                        ...
                        <div className=" p-5 rounded-lg md:mt-6 mt-20">
                            <h1 className='text-2xl font-medium mb-4'>Contact Informations</h1>
