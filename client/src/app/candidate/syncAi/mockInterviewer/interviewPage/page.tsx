            ...
            <div className=" w-full h-full flex flex-col justify-center items-center p-10">
                ...
                <div className="mt-20 flex justify-evenly  w-full">
                    <div className='max-w-2/5 '>
                        <div className="flex flex-col gap-5 border p-10 rounded-lg">
                            <h1 className='text-xl'><span className='font-semibold'>Job Role/Job Position : </span>{data?.jobPosition}</h1>
                            <h1 className='text-xl'><span className='font-semibold'>Job Description/ Tech Stack : </span>{data?.jobDescription}</h1>
                            <h1 className='text-xl'><span className='font-semibold'>Years of Experience : </span>{data?.jobExperience}</h1>
                            <h1 className='text-xl'><span className='font-semibold'>Difficulty Mode : </span>{data?.mode}</h1>
                            <h1 className='text-xl'><span className='font-semibold'>Number of Questions : </span>{data?.numberOfQuestions}</h1>
                        </div>
